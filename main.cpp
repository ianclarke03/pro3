...
int main() {
  ...
  // Test constructor
  Post post1("Chicken came before the egg confirmed!", "A new story just released where we finally get the answer of who came first.", "@ian");

  // Test constructor and accessor functions
  std::cout << post1.getTitle() << std::endl;
  std::cout << post1.getBody() << std::endl;
  post1.getTimeStamp(); //originally without the std::cout <<... idk
